...
* Here is the distinction for the padding, border, & margin. I was getting confuse & lost where in the element it is. Here's a few images I use to remember ![mozilla example](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics/box-model.png) ![CS260 example](https://github.com/webprogramming260/.github/raw/main/profile/css/introduction/cssBoxModel.jpg)
